    ...
    <View>
      <View style={[styles.row]}>
        <View style={[styles.row, { height: 'auto' }]}>
          ...
          <TextInput
            onChangeText={text => {
              setData0401({ ...data0401, ten_chutau: text });
            }}
            value={data0401?.ten_chutau}
      ...
      <View style={[styles.row, { height: 'auto' }]}>
        ...
        <TextInput
          onChangeText={text => {
            setData0401({ ...data0401, ten_thuyentruong: text });
          }}
          value={data0401?.ten_thuyentruong}
          style={[styles.input, styles.text]}
        />
      </View>
      ...
      <View style={[styles.row, { height: 'auto' }]}>
        ...
        <View style={[styles.row, { width: '50%', height: 'auto' }]}>
          ...
          <TextInput
            // editable={false}
            onChangeText={text => {
              setData0401({ ...data0401, tau_tongcongsuatmaychinh: text });
            }}
      ...
      <View style={[styles.row, { height: 'auto' }]}>
        ...
        <TextInput
          // editable={false}
          onChangeText={text => {
            setData0401({ ...data0401, tau_chieudailonnhat: text });
          }}
      ...
      <View style={[styles.row]}>
        <View style={[styles.row, { width: '50%' }]}>
          ...
          <TextInput
            // editable={false}
            onChangeText={text => {
              setData0401({ ...data0401, gpkt_so: text });
            }}
            value={data0401?.gpkt_so}
            style={[styles.input, styles.text]}
          />
          <Text style={styles.text}>;</Text>
        </View>
        ...
        <View style={[styles.row, { width: '50%' }]}>
          ...
          <TextInput
            onChangeText={text => {
              // setData0401({...data, gpkt_thoihan: text});
            }}
            value={data0401.gpkt_thoihan}
            style={[styles.input, styles.text]}
          // editable={false}
          />
